...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To Vaquela Installer ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Author : ${green} ® ${NC}${YELLOW}(${NC} ${green} Abi Developer${NC}${YELLOW})${NC}"
echo -e " © Recode By Vaquela Team ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/abidevo/tunel/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/abidevo/ip/main/akses"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/abidevo/tunel/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
